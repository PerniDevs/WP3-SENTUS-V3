...
PvtHdr = "#SOD      LONEST     LATEST        ALTEST     CLKEST    GGTO   SOL NSVVIS  NSV     HPE     VPE      EPE     NPE     UPE    HDOP    VDOP    PDOP    \n"

# Line format
PvtFmt = "%05d %10.5f %10.5f %13.3f %9.3f %9.3f %5d %5d %5d %7.3f %7.3f %7.3f %7.3f %7.3f %7.3f %7.3f %7.3f".split()
...
def generatePvtFile(fpvt, PosInfo):
    ...
    # Prepare outputs
    Outputs = OrderedDict({})
    Outputs["SOD"] = int(PosInfo["Sod"])
    Outputs["LONG"] = PosInfo["Lon"]
    Outputs["LAT"] = PosInfo["Lat"]
    Outputs["ALT"] = PosInfo["Alt"]
    Outputs["CLK"] = PosInfo["Clk"]
    Outputs["GGTO"] = PosInfo["Ggto"]
    Outputs["SOL"] = PosInfo["Sol"]
    Outputs["NUMSATSVIS"] = PosInfo["NumSatsVis"]
    Outputs["NUMSAT"] = PosInfo["NumSat"]
